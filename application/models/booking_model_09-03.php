...
class Booking_model extends CI_Model {
	...
	function GetReportBooking($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by='',$status='',$perPage=20, $pageNo=1,$employee='',$unit='',$pending=''){ 
    ...
    function CountBooking($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by='',$status='',$employee='',$unit='',$pending=''){ 
		//echo date('Y-m-d');  die;
	...
	function GetBookingSummary($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by='',$status='',$group_by,$employee='',$unit='',$pending=''){   
		$condition = "";
		$cur_date = date('Y-m-d');
		if($pending=='')
		{
	...
	function GetBookingSummarySumReport($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by='',$status='',$group_by,$employee='',$rejected='',$unit='',$pending=''){   
		$condition = "";
		$cur_date = date('Y-m-d');
		if($pending=='')
		{
	...
	function GetBookingSummaryLocked($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by='',$status='',$group_by,$employee='',$unit='',$pending=''){   
		$condition = "";
		$cur_date = date('Y-m-d');
		if($pending=='')
		{
	...
	function product_packing_type_summary($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by='',$status='',$group_by,$employee='',$rejected='',$unit='',$pending='')
	{
		$condition = "";
		$cur_date = date('Y-m-d');
		if($pending=='')
