...
class Secondarybooking extends CI_Controller {
    ...
    public function getcurrentdata($vendor_id=578) {             
        $party_id = $vendor_id;  
        $party=  $vendor_id;  
        $post_month = date('m');
        $post_year = date('Y');
    ...
    public function GetBookingInfoDetailsPdf(){ 
        ...
        { 
            ...
            curl_setopt_array($curl_watsappapi, array( 
            CURLOPT_URL => 'https://dlr.dil.in/notify.jsp?TYPE=WAB&F=918764216255&T=7792047479&TID=8909629&P='.$message_params.'&PATH='.$pdf_file,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
