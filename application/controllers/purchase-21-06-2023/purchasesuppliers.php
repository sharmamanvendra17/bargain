...
class Purchasesuppliers extends CI_Controller {
    ...
    { 
        ...
        $this->load->model('purchase/distributor_model');   

        $this->load->model('purchase/purchase_vendor_model');   
    ...
    public function index(){ 
    	...
    	$this->load->view('purchase/suppliers/distributors',$data);
    ...
    public function edit_distributor(){  
        ...
        $distributor_id =  base64_decode($this->uri->segment(4));
        ...
        $this->load->view('purchase/suppliers/distributor_edit',$data);
    } 
    ...
    public function getsuppliers(){    
        $vendor_id = $_POST['party_id'];
        $condition = array('pur_suppliers.vendor_id'=> $vendor_id);
        $cities = $this->distributor_model->GetSuppliersList($condition);
        $res = "<option value=''>Select Supplier</option>";
        if($cities)
        {
            foreach ($cities as $key => $value) {
