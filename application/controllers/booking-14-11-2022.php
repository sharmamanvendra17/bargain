...
class Booking extends CI_Controller {
    ...
    public function report(){    
        ...
        //if(!empty($_POST))
        {
            ...
            else
            {
                ...
                $data['bookings_product'] = $this->booking_model->GetBookingSummary($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by,$booking_status,$group_by,$employee);
    ...
    public function report_print(){    
        ...
        $limit = 2000000;
        $page = 1;
        $bookings = $this->booking_model->GetReportBooking($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by,$booking_status,$limit,$page,$employee);
        $html_print = '';
    ...
    public function summary_print(){    
        ...
        $tot_sum_report = $this->booking_model->GetBookingSummarySumReport($party_id,$brand_id,$category_id,$booking_date_from,$booking_date_to,$booked_by,'',array(),$employee,1);
