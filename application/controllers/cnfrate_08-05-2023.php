    ...
    public function GetBookingSkusRates(){  
        ...
        if($skulists)
        {
            ...
            foreach ($skulists as $key => $value) {  
                ...
                {
                    if(($value['state_id']==4 || $value['state_id']==22 || $value['state_id']== 23 || $value['state_id']==24|| $value['state_id']==25|| $value['state_id']==30|| $value['state_id']==33) && $value['base_rate']==0) 
                    {
            ...
            $res .='<div class="col-md-12">
                                        <div class="form-group"> 
                                            ...
                                            <a class="btn btn-default send_pdf" href="javascript:void(0)">Send PDf</a>
