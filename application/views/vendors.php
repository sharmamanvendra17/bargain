        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="title elipsis header_add">
                    <a href="<?php echo base_url();?>vendors/add">Add New Party</a>
                </span>
            </div>
                                ...
                                <tbody>
                                    <?php if($users) { 
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="<?php echo base_url(); ?>vendors/edit_vendor/<?php echo base64_encode($value['id']);?>"> Edit</a> &nbsp; 


                                                <!--<a href="<?php echo base_url(); ?>vendors/delete_vendor/<?php echo base64_encode($value['id']);?>" onClick="if(confirm('Are you want to sure delete this party?')) return true; else return false"> Delete</a>-->
