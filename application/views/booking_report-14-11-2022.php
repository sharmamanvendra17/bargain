            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">                         
                            ...
                            <div class="row">                               
                                ...
                                <div class="col-md-4">
                                    <?php if($bookings) { 
                                        $params_report = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=brand&status=$_POST[status]&employee=$_POST[employee]"; ?>
                ...
                <div class="table-responsive">
                            ...
                            <?php $total_weight = 0; if($bookings) { 
                                ...
                                foreach ($bookings as $key => $value) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <?php }
                                        elseif($value['status']==2 && $value['is_lock']==0)
                                        { ?>
                    ...
                    <?php } else { 
                        ...
                        $params_product = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=combo&status=$_POST[status]&employee=$_POST[employee]";
                        ?>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:left;">Avg Rate / Loose(kg)</th>
                            </tr>
                        </thead>
                        <tbody class="">
                            <?php $weight_total_summary = 0; $sn = 1; if($bookings_product) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        echo $avg_rate =  round($bookings_brand_product1['avg_rate'],2);

                                        $loose_kg = (strtolower($bookings_brand_product1['category_name'])=='vanaspati') ? 13.455 : 13.650;
                                        echo ' / ';
                                        $loose_rate = ($avg_rate-$bookings_brand_product1['tin_rate'])/$loose_kg;
                                        echo round($loose_rate,2); ?>   
                                    </td> 
                                </tr>
                            <?php $sn++; }?>
                            <tr style="color:red;"><td colspan="2"></td><td>Total</td><td ><?php echo $weight_total_summary; ?></td><td></td></tr>
                            <?php  } else { ?>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="">
                        ...
                        <tbody class="">
                            ...
                            <?php $sn++; }?>
                            <tr style="color:red;"><td colspan="3"></td><td>Total</td><td ><?php echo $weight_total_summary; ?></td><td></td></tr>
                            <?php  } else { ?>
                        ...
                        <tbody class="">
                            <?php $weight_total_summary = 0; $sn = 1; if($bookings_brand_product_place) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        echo $avg_rate =  round($bookings_brand_product_place1['avg_rate'],2);
                            ...
                            <?php $sn++; } ?>
                            <tr style="color:red;"><td colspan="4"></td><td>Total</td><td ><?php echo $weight_total_summary; ?></td><td></td></tr>
                            <?php } else { ?>
