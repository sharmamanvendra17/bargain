                            ...
                            <?php if($products) 
                            {
                                ...
                                foreach ($products as $key => $value) {
                                    ...
                                    else
                                    {
                                        ...
                                        $res .= '<input type="hidden" class="update_id_r" name="update_id[]" value="0"><input type="hidden" class="packing_weight'.$i.' packing_weight" name="packing_weight[]" value="'.$mt.'"><input type="hidden" class="packing_type" name="packing_type[]" value="'.$value['packaging_type'].'"><input type="hidden" class="packed_items_quantity" name="packed_items_quantity[]" value="'.$value['gross_weight'].'">
