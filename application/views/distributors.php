        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="title elipsis header_add">
                    <a href="<?php echo base_url();?>distributors/add">Add New Distributor</a>
                </span>
            </div>
                                ...
                                <tbody>
                                    <?php if($users) { 
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="<?php echo base_url(); ?>distributors/edit_distributor/<?php echo base64_encode($value['distributor_id']);?>"> Edit</a> &nbsp;
