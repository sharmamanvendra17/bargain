                    ...
                    <ul class="nav nav-list">
                        ...
                        <li>
                            ...
                            <ul>
		                        ...
		                        <li>
		                            <a class="dashboard" href="<?php echo base_url(); ?>employee">
		                                <i class="main-icon fa fa-dashboard"></i> <span>Employee Management</span>
		                            </a>
		                        </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul>
		                        <li>
		                            ...
		                            <ul>
		                                <li><a href="<?php echo base_url(); ?>booking/report">Bookings Report</a></li>
                        ...
                        <li>
                            <a class="dashboard" href="javascript:void(0)">
                                <i class="main-icon fa fa-dashboard"></i> <span>Admin Management</span>
                            </a>
                        </li>
                        <li>
                            <a class="dashboard" href="<?php echo base_url(); ?>changepassword">
                                <i class="main-icon fa fa-lock"></i> <span>Change Password</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="dashboard" href="#">
                                <i class="main-icon fa fa-dashboard"></i> <span>Orders</span>
                            </a>
                            <ul>
                                <li><a href="<?php echo base_url(); ?>paid_orders">Paid Orders</a></li>
                                <li><a href="<?php echo base_url(); ?>unpaid_orders">Unpaid Orders</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="dashboard" href="<?php echo base_url(); ?>reports">
                                <i class="main-icon fa fa-bar-chart"></i> <span>Transaction Reports</span>
                            </a>
                        </li>
                ...
                <nav>
                    ...
                    <ul class="nav pull-right">
                        ...
                        <li class="dropdown pull-left">
                            ...
                            <?php echo ucwords($admin_role); ?> <i class="fa fa-angle-down"></i>
                            </span>
                            </span>
                            </a>
