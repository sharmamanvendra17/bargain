...
<section id="middle">
    ...
    <div id="content" class="padding-20">
        <div id="panel-1" class="panel panel-default">
            <form action="<?php echo base_url('booking/report/'); ?>" class="" method="post" id="">
                        ...
                        <div class="col-md-4">
                            <span class="title elipsis header_add" >
                                <div class="form-group cal" style="margin-bottom:0px!important"> 
                                    <input class="form-control" type="text" name="bagainnumber" id="bagainnumber" value="<?php echo (isset($_POST['bagainnumber'])) ? $_POST['bagainnumber'] : ''; ?>" placeholder="Search By Bargain Number" />
                                </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">                         
                            ...
                            <div class="row" >
                                <div class="col-md-12">
                                    <div class="form-group"> 
                                        ...
                                        <input class="" type="radio" id="" name="status"  value="0" <?php echo (isset($_POST['status']) && $_POST['status']=='0') ? 'checked' : ''; ?> />Approval Pending
                                        ...
                                        <input class="" type="radio" id="" name="status"  value="pending_dispatch" <?php echo (isset($_POST['status']) && $_POST['status']=='pending_dispatch') ? 'checked' : ''; ?> />Pending Dispatch
                            ...
                            <div class="row" >
                                <div class="col-md-8">
                                    <div class="form-group"> 
                                        <label for="rate">Pending</label>
                                        <input class="" type="radio" id="" name="pending"  value=""   <?php echo (!isset($_POST['pending']) || $_POST['pending']=='') ? 'checked' : ''; ?> />All
                                        <input class="" type="radio" id="" name="pending"  value="15" <?php echo (isset($_POST['pending']) && $_POST['pending']=='15') ? 'checked' : ''; ?> />15 days
                                        <input class="" type="radio" id="" name="pending"  value="30" <?php echo (isset($_POST['pending']) && $_POST['pending']=='30') ? 'checked' : ''; ?> />30 Days
                                        <input class="" type="radio" id="" name="pending"  value="45" <?php echo (isset($_POST['pending']) && $_POST['pending']=='45') ? 'checked' : ''; ?> />45 Days                                        
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group"> 
                            ...
                            <div class="row">                               
                                ...
                                <div class="col-md-4">
                                    <?php if($bookings) { 
                                        $params_report = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=brand&status=$_POST[status]&employee=$_POST[employee]&production_unit=$_POST[production_unit]&pending=$_POST[pending]&broker=$_POST[broker]"; ?>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="">
                        ...
                        <tbody class="booking_records">
                            <?php  $rate_diff_total = 0; $total_weight = 0; if($bookings) { 
                                $i=1;
                                $count = 1;
                                $cur_page =1;
                                if(isset($limit))
                                ...
                                foreach ($bookings as $key => $value) {
                                    ...
                                    if($value['is_lock']==1){
                                        $lock_img = '/lock.png';
                                        $lock_status = 1;
                                        $lock_msg = 'Bargain complete';
                                    }
                                    if($value['is_lock']==2){
                                        $lock_img = '/lock-yellow.png';
                                        $lock_status = 2;
                                        $lock_msg = 'Weight pending';
                                    }

                                    if($value['status']==6){
                                        $lock_img = '/lock-red.png';
                                    }
                                    $diff_flag = 1;
                                    if($value['pi_ids'])
                                    { 
                                        ...
                                        if($lock_status && $remaining_pi_skus==0)
                                        {
                                            ...
                                            {
                                                if($withouttruck_pi ==0 && $lock_status != 2)
                                                {
                                                    $diff_flag = 0;
                                                } 
                                            } 
                                    ...
                                    <tr class="odd gradeX">
                                        <td><span title="PI : <?php echo $value['pi_ids']; ?>"><?php echo $count; ?></span></td>
                                        <td><span title="<?php echo $value['admin_name']; ?> / <?php echo $value['admin_mobile']; ?>">DATA/<?php echo $value['booking_id']; ?>
                                            ...
                                            if($value['not_pi_sku']==0 && $value['withouttruck']==0 && $value['pi_ids'])
                                                echo '';
                                            else
                                                echo ($days) ? '<br><strong>('.$days.' Day)</strong>' : ''; ?>
                                        ...
                                        <td class="text-center"><?php echo $value['quantity']; echo "<br>";
                                            if(strtolower($value['production_unit'])=='jaipur' && $value['total_weight_net']>0)
                                            {
                                                echo round($value['total_weight_net'],2).'(MT)';
                                                $pending_dispatch_weight = round(($value['total_weight_net']-$value['total_dispatch']),2);
                                                echo '<br><span style="color:red">'.$pending_dispatch_weight.'(MT)</span>';
                                            }
                                            else
                                            {
                                                echo round($value['weight'],2).'(MT)';  
                                                $pending_dispatch_weight = round(($value['weight']-$value['total_dispatch']),2);
                                                if($pending_dispatch_weight)
                                                    echo '<br><span style="color:red">'.$pending_dispatch_weight.'(MT)</span>';
                                            } ?> 
                                        </td>  
                                        <td class="text-center"><?php echo $value['rate']; ?><br>
                                            ...
                                            if($value['loose_oil_rate_kg_max']>0 && $pending_dispatch_weight>0)
                                            { 
                                            $bargain_base = $value['loose_oil_rate_kg']*$pending_dispatch_weight*1000;
                                            $current_base = $value['loose_oil_rate_kg_max']*$pending_dispatch_weight*1000;
                                            echo '<br><span style="color:red">'.number_format($bargain_base,2).'</span>';
                                            }
                                            ?> 
                                        </td> 
                                        <td class="text-center">
                                            <?php
                                            if($value['loose_oil_rate_kg_max']>0 && $pending_dispatch_weight>0 && $diff_flag==1)
                                            { 
                                                echo '<strong>'.$value['loose_oil_rate_kg_max'].'/kg</strong>';
                                                echo '<br><span style="color:blue">'.number_format($current_base,2).'<br></span>'; 
                                            $diff = $bargain_base-$current_base; 
                                                $rate_diff_total = $rate_diff_total+$diff;
                                                echo ($diff>0) ? '<span style="color:green">'.number_format($diff,2).'<br></span>' : '<span style="color:red">'.number_format($diff,2).'<br></span>'; 
                                            }
                                            ?>
                                        </td>
                                        <td><?php echo ucwords($value['production_unit']); ?></td>
                                        ...
                                        <?php } elseif($value['status']==2) { 
                                            $app_status = 1; ?>
                                            <span class="btn btn-default <?php echo ($logged_role == 4 || (($logged_in_id==$value['team_lead_id']) || $logged_role == 5)) ? 'update_status_reject' : 'style="cursor:none"'; ?>" data-dispatch-status="<?php echo $value['dispatch_status']; ?>" data-status="<?php echo ($value['dispatch_status'] && $logged_role == 4) ? 6 : 3; ?>" lock-status="<?php echo $lock_status; ?>" rel="<?php echo base64_encode($value['id']); ?>" ><img style="height: 17px;width: 17px;" src="<?php echo base_url('assets/img').$lock_img; ?>"> 
                                                <?php //echo ($value['pi_ids']) ? "PI" : "Approved"; 
                                                    ...
                                                    { 
                                                        ...
                                                        if($lock_status && $remaining_pi_skus==0)
                                                        {
                                                            if($lock_status == 2){
                                                                $sku_msg = ' with no SKU';
                                                                $dispactch_msg = ' Partially Dispatched '.round($value['total_dispatch'],2).' (MT)';
                                                            }
                                                            if($lock_status == 1){
                                                                $sku_msg = '';
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if($withouttruck_pi==0 || $withtruck_pi==0)
                                                            {
                                                                if($withouttruck_pi == 0)
                                                                {
																	...
																	$dispactch_msg = ' Partially Dispatched'.round($value['total_dispatch'],2).' (MT)';;
                                                                    echo '<img style="height: 35px;" src="'.base_url('assets/img/half-truck.png').'" title="SKU Pending for PI and No PI pending for dispatch. Dispatched '.round($value['total_dispatch'],2).' (MT)">';
                                                                }
                                                                else
                                                                {
                                                                    $dispactch_msg = ' and Dispatch Pending';
                                                            ...
                                                            {
                                                                $dispactch_msg = ' and Partially Dispatched'.round($value['total_dispatch'],2).' (MT)';;
                                                                $title = $lock_msg.$sku_msg.$dispactch_msg;
                                                                echo '<img style="height: 35px;" src="'.base_url('assets/img/half-truck.png').'" title="'.$title.'">';
                                                            }
                                                        }
                                                    ...
                                                    {
                                                        $dispactch_msg = ' and PI Pending';
														$title = $lock_msg.$sku_msg.$dispactch_msg;
														echo '<span title="'.$title.'">Approved</span>'; 
                                                    }
                                        ...
                                        <span class="btn btn-danger <?php echo ($logged_role == 4 && $value['status']!=6) ? 'update_status_reject' : 'style="cursor:none"'; ?>"  data-status="3" lock-status="<?php echo $lock_status; ?>" rel="<?php echo base64_encode($value['id']); ?>" > <img style="height: 17px;width: 17px;" src="<?php echo base_url('assets/img').$lock_img; ?>">  <?php echo ($value['status']==6) ? '<img style="height: 35px" src="'.base_url("assets/img/full-truck.png").'">' : "Approval Pending"; ?>  </span>
                                        <?php } ?>
                    ...
                    <?php } else { 
                        $params = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=brand&status=$_POST[status]&employee=$_POST[employee]&production_unit=$_POST[production_unit]&pending=$_POST[pending]&broker=$_POST[broker]";
                        $params_place = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=place&status=$_POST[status]&employee=$_POST[employee]&production_unit=$_POST[production_unit]&pending=$_POST[pending]&broker=$_POST[broker]";

                        $params_broker = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=broker&status=$_POST[status]&employee=$_POST[employee]&production_unit=$_POST[production_unit]&pending=$_POST[pending]&broker=$_POST[broker]";

                        $params_product = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=combo&status=$_POST[status]&employee=$_POST[employee]&production_unit=$_POST[production_unit]&pending=$_POST[pending]&broker=$_POST[broker]";
                        ?> 
                    ...
                    <div class="row summary_report">
                        ...
                        <div class="col-md-3 summary_report_col">
                            <strong>Locked SKU Weight (MT) </strong>
                        </div>
                    </div>  
                    <?php
                    ...
                    <table class="table table-striped table-bordered table-hover" id="">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2"style="text-align:left; vertical-align: middle;">Bulk (MT)<br>(Locked SKU)</th>
                                <th rowspan="2"style="text-align:left; vertical-align: middle;">Consumer (MT)<br>(Locked SKU)</th>
                        ...
                        <tbody class="">
                            <?php
                                ...
                                $weight_total_summary = 0; $sn = 1; if($bookings_product) {
                                foreach ($bookings_product as $key => $bookings_brand_product1) { 
                                    ...
                                    $weight_bulk_total_summary = $weight_bulk_total_summary+$bookings_brand_product1['bulk_weight'];
                                    $weight_cunsomer_total_summary = $weight_cunsomer_total_summary+$bookings_brand_product1['consumer_weight']; 
                                    ?>
                                <tr>
                                    <td><?php echo $sn; ?></td>   
                                    ...
                                    <td><?php echo round($bookings_brand_product1['bulk_weight'],2); ?></td>
                                    <td><?php echo round($bookings_brand_product1['consumer_weight'],2); ?></td>
                            ...
                            <?php $sn++; }?>
                            <tr style="color:red;"><td colspan="2"></td><td>Total</td><td ><?php echo round($weight_total_summary,2); ?></td> <td ><?php echo round($weight_bulk_total_summary,2); ?></td> <td ><?php echo round($weight_cunsomer_total_summary,2); ?></td><td colspan="2"></td></tr>
                            <?php  } else { ?>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="">
                        ...
                        <tbody class="">
                            <?php $weight_bulk_total_summary = 0;
                                $weight_cunsomer_total_summary = 0;  
                                $weight_total_summary = 0; $sn = 1; if($bookings_brand_product) {
                            ...
                            <?php $sn++; }?>
                            <tr style="color:red;"><td colspan="3"></td><td>Total</td><td ><?php echo round($weight_total_summary,2); ?></td><td><?php echo round($weight_bulk_total_summary,2); ?></td> <td><?php echo round($weight_cunsomer_total_summary,2); ?></td><td colspan="2"></td></tr>
                            <?php  } else { ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="">
                            ...
                            <tbody class="">
                                <?php $weight_bulk_total_summary = 0;
                                    $weight_cunsomer_total_summary = 0;   $weight_total_summary = 0; $sn = 1; if($bookings_brand_product_place) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo round($bookings_brand_product_place1['bulk_weight'],2); ?></td>
                                        <td><?php echo round($bookings_brand_product_place1['consumer_weight'],2); ?></td> 
                                        <td>
                                            <?php 
                                ...
                                <?php $sn++; } ?>
                                <tr style="color:red;"><td colspan="4"></td><td>Total</td><td ><?php echo round($weight_total_summary,2); ?></td><td><?php echo round($weight_bulk_total_summary,2); ?></td> <td><?php echo round($weight_cunsomer_total_summary,2); ?></td><td colspan="2"></td></tr>
                                <?php } else { ?>
                    ...
                    <h4>Summary Based on Broker State
                        <?php if($bookings_broker_place) { ?>
                            <a class="btn btn-default"  style="display: inline-block;float: right;" target="_blank" href="<?php echo base_url('booking/summary_print').$params_broker; ?>">Print</a>
                        <?php } ?>
                    </h4>
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="">
                            <thead>
                                <tr>
                                    <th rowspan="2" style="text-align:left; vertical-align: middle;">S.No</th>  <th rowspan="2" style="text-align:left; vertical-align: middle;">Broker Name</th>  
                                    <th rowspan="2" style="text-align:left; vertical-align: middle;">State</th>
                                    <th rowspan="2" style="text-align:left; vertical-align: middle;">Qty (Tins/Cartons)</th>
                                    <th rowspan="2" style="text-align:left; vertical-align: middle;">Weight (MT)</th>
                                    <th rowspan="2"style="text-align:left; vertical-align: middle;">Bulk (MT)<br>(Locked SKU)</th>
                            ...
                            <tbody class="">
                                <?php $weight_bulk_total_summary = 0;
                                    $weight_cunsomer_total_summary = 0;   $weight_total_summary = 0; $sn = 1; if($bookings_broker_place) {
                                    foreach ($bookings_broker_place as $key => $bookings_brand_product_place1) { 
                                        $weight_total_summary = $weight_total_summary+$bookings_brand_product_place1['weight'];
                                        $weight_bulk_total_summary = $weight_bulk_total_summary+$bookings_brand_product_place1['bulk_weight'];
                                        $weight_cunsomer_total_summary = $weight_cunsomer_total_summary+$bookings_brand_product_place1['consumer_weight'];
                                         ?>
                                    <tr>
                                        <td><?php echo $sn; ?></td>  
                                        <td><?php echo $bookings_brand_product_place1['broker_name']; ?></td> 
                                        <td><?php echo $bookings_brand_product_place1['state_name']; ?></td>
                                        <td><?php echo $bookings_brand_product_place1['quantity']; ?></td> 
                                        <td><?php echo round($bookings_brand_product_place1['weight'],2); ?></td>
                ...
                <?php if($search_summary == 0) { ?>
                <div>
                    <span><strong>Total Approved Bargain : <?php echo ($total_bargain['total_bargain_weight']) ? round($total_bargain['total_bargain_weight'],2) : 0; ?> (MT)</strong></span> <br>
                    <span><strong>Total Dispatched Bargain : <?php echo ($total_dispatch['total_dispateched_weight']) ?  round($total_dispatch['total_dispateched_weight'],2)  : 0; ?> (MT)</strong></span> 
                    <br>
                    <span><strong>Settlement amount as on today : <?php echo number_format($rate_diff_total,2) ; ?> (For the above records)</strong></span>
                </div>
                <?php } ?>
            </div>
            </form>
...
$(document).ready(function(){
    ...
    $(document).ready(function(){ 
        ...
        $(document).on('click', '.detail', function(){
            ...
            $.ajax({
                ...
                success: function(msg){ 
                    ...
                    if(user_role==2 || user_role==3 || user_role==5 || user_role==4)
                    {
        ...
        $(document).on('click', '.update_status_reject', function(){
            ...
            {
                var btn = '<span class="btn btn-danger update_status" rel="'+booking_id+'" data-status="6"><a class="reject_status_label" style="color:#fff;" href="javascript:void(0)" >Partial Reject</a></span>';
                
                $( '#reject_radio' ).click();
                $( '#reject_radio' ).val(6);  
                $(".reject_radio_span span").html("Partial Reject"); 
                $(".reject_status_label").text("Partial Reject"); 
            }
            else
            {
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">  
                        ...
                        <input type="radio" id="reject_radio" class="reject_status_radio" name="reject_status" value="3" > <span>Reject</span>
                        </span>
                        ...
                        <?php } ?>        
                        <?php if($logged_role==4 || $logged_role==5)  { ?>                
    ...
    <div class="modal-content">
        <form method="POST" id="">
            ...
            <div class="modal-footer">
                ...
                <?php if($logged_role == 4 || $logged_role == 3 || $logged_role == 2 || $logged_role == 5) { ?>
