    ...
    <div id="content" class="padding-20">
        <div id="panel-1" class="panel panel-default">
            ...
            <div class="panel-body">
                    <form action="" class="" method="post" id="reportform">
                        <div class="row"> 
                            <div class="col-md-3">
                        ...
                        <div class="row">                               
                            <div class="col-md-4">
                                <div class="form-group"> 
                                    ...
                                    <button id="submit" type="submit" class="btn btn-default search_report" value="Search" name="submit">Search History</button>  
                                    <?php   if( $results ) { ?>
                                    <button id="download_report" type="submit" class="btn btn-default download_report" value="download_report" name="download_report">Download Report</button>  
                                    <?php } ?>
                                </div>                                  
                            </div>  
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">  
                                ...
                                <nav class='animated saleAccordion bounceInDown'> 
                                    <ul>
                                        <?php  $party_no = 1; $tot_dispatch = 0; $tot_net_dispatch = 0; if($results) { 
                                            foreach ($results as $key => $value) {
												$tot_dispatch = $tot_dispatch + round($value['total_dispatch'],2);
                                                $tot_net_dispatch = $tot_net_dispatch + round($value['total_net_dispatch'],2);
                                                            ...
                                                            <table class="table accordionTable table-striped table-bordered table-hover ">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr> 
                                                                        ...
                                                                        <td class="text-center"><?php echo round($detailed_value['total_net_dispatch'],2) ?></td>
                                                                    </tr>
                                                                    <?php $sno++; } ?>
                                                                </tbody>
                                                            </table>   
                                    ...
                                    <div class="table-responsive"> 
                                        <table class="table accordionTable table-striped table-bordered table-hover ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr> 
                                                    <td class="text-center"><?php echo $sno; ?></td>
                                                    <td class="text-center"><?php echo $summary_value['brand_name'] ?></td>
                                                    <td class="text-center"><?php echo $summary_value['category_name'] ?></td>        
                                                    <td class="text-center"><?php echo round($summary_value['total_dispatch'],2) ?></td>
                                                    <td class="text-center"><?php echo round($summary_value['total_net_dispatch'],2) ?></td>
                                                </tr>
                                                <?php $sno++; } ?>                                                
                                                <tr><td colspan="3" class="text-right"><strong>Total</strong></td><td class="text-center"><strong><?php echo $tot_dispatch; ?></strong></td><td class="text-center"><strong><?php echo $tot_net_dispatch; ?></strong></td></tr>
                                            </tbody>
                                        </table>   
                                    </div>
                                <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">  
                                <h4>Employee Report State wise Only</h4>
                                <?php  $sn = 1; $tot_dispatched_weight = 0;  $tot_dispatched_net_weight = 0;  if( $results ) { ?>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover">
                                            <tr>
                                                ...
                                                <td>Mobile Number</td> 
                                                <td>Dispatch (MT)</td>  
                                                <td>Net Dispatch (MT)</td>  
                                            </tr>
                                            <?php foreach ($results as $key => $value) { 
											$tot_dispatched_weight = $tot_dispatched_weight + round($value['total_dispateched_weight'],2);
                                            $tot_dispatched_net_weight = $tot_dispatched_net_weight + round($value['total_dispateched_net_weight'],2);
											?>
                                            <tr>
                                                <td><?php echo $sn; ?></td> 
                                                <td>
                                                ...
                                                <td><?php echo ($value['total_dispateched_net_weight']) ? round($value['total_dispateched_net_weight'],2) : round($value['total_dispateched_net_weight1'],2);  ?></td>  
                                            </tr>
                                            <?php $sn++; } ?>
                                        </table>
                                    </div>
                                    <div style="margin-bottom:15px;margin-top:-15px;"><strong> Total Dispatch : <?php echo $tot_dispatched_weight; ?> </strong></div>
                                <?php }  ?>
                            </div> 
                            <div class="col-md-12">
                            <?php if(isset($_POST['state']) && !empty($_POST['state'])) { 
...
$(document).ready(function(){    
    ...
    if(state_id!='')
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>booking/getcity',
    ...
    $(document).on('click', '.download_report', function(){
        $("#reportform").attr('action', 'state_city_report_excel');
    });
