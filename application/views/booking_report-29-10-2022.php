        ...
        <div id="panel-1" class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    ...
                    <?php } else { 
                        $params = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=brand&status=$_POST[status]";
                        $params_place = "?party=$_POST[party]&brand=$_POST[brand]&product=$_POST[category]&from=$_POST[booking_date_from]&to=$_POST[booking_date_to]&type=place&status=$_POST[status]";
                        ?>
