...
<section id="middle">
    <header id="page-header">
        <h1><?php echo $title; ?> <strong>(<?php echo 'Bargain No.: DATA/'.$booking_info['booking_id']; ?>) (<?php echo $booking_info['party_name']; ?>)</strong></h1> 
    </header>
                    ...
                    <div class="col-md-12"> 
                        ...
                        <div class="row">  
                            <div class="col-md-4 text-center">
                                Ordered SKU Weight <br><span class="weightValue total_weight_ordered"><?php echo 'Gross : '.$booking_info['total_weight']; ?> MT 
                                    <?php echo (isset($booking_info['total_weight_net']) && $booking_info['total_weight_net']>0) ? '<br>Net : '.$booking_info['total_weight_net'].' MT' : ''; ?> 
                                </span>  
                            </div>  
                            <div class="col-md-4 text-center">                
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="flag" id="flag" value="<?php echo $booking_info['is_lock']; ?>">
                        </div>
                        <div class="row"> 
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category" name="category" required>
                                        ...
                                        <?php } } } else { ?>
                                            <option value="<?php echo $booking_info['category_id']; ?>"><?php echo $booking_info['category_name']; ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rate" id="rate" name="rate"  value="<?php echo $booking_rate = $booking_info['rate']; ?>" required readonly>
                        ...
                        <div class="packing">
                            ...
                            <?php if($products) 
                            {
                                ...
                                foreach ($products as $key => $value) {
                                    if(strtolower($booking_info['production_unit'])=='jaipur' && $booking_info['total_weight_net']>0 )
                                        $value['gross_weight'] = $value['packing_items'];
                                    if (array_key_exists($value['id'],$skus))
                                    {
                                        $product_skus = $skus[$value['id']];
                                        foreach ($product_skus as $product_skus_key => $product_skus_value) {  
                                                $res .= '<div class="sku_row row_'.$i.'"><div class="row"><div class="col-md-3"><div class="form-group">';

                                            $addeddate= '';
                                            if (array_key_exists($value['id'],$skus))
                                                $addeddate= date('d-m-Y H:i:s', strtotime($product_skus_value['created_at']));
                                            ...
                                            $res .= '</select>
                                            <span style="color:red">'.$addeddate.'</span>
                                            ...
                                            if (array_key_exists($value['id'],$skus))
                                            {
                                                $update_id  = $product_skus_value['id'];
                                                $sku_status  = $product_skus_value['is_lock'];
                                                $lock_img = '/un-lock.png';
                                                $sku_id  =$product_skus_value['id'];
                                                $update_sku_status = 'update_sku_status';
                                                $addeddate= date('d-m-Y H:i:s', strtotime($product_skus_value['created_at']));
                                                if($product_skus_value['is_lock']==1)
                                                {
                                                    $update_sku_status = '';
                                                    $locked = 1;
                                                ...
                                                $v = $product_skus_value['quantity'];
                                                $packing_type = $value['packaging_type'];


                                                $packed_items_quantity = $value['gross_weight']; 
                                                $packed_items_quantity_net = $value['product_weight']; 
                                                $l_to_kg = 1; 
                                                //$approx_weight=0.02;
                                                $approx_weight=.075;
                                                if($packing_type!=1)
                                                ...
                                                if(($l_to_kg ==.91 && strtolower($value['category_name'])=='vanaspati'))
                                                {
                                                    $l_to_kg = .897; 
                                                    //$approx_weight = .01794; 
                                                    $approx_weight = .067275; 
                                                }

                                                $total_weight_kg= (($v*$packed_items_quantity)*$l_to_kg);

                                                if($value['packaging_type']==3)
                                                {
                                                   $net_weight_1 = ($value['product_weight']/1000)*$value['packing_items_qty']; 
                                                }
                                                else
                                                {
                                                    $net_weight_1 = $value['product_weight']*$value['packing_items_qty']; 
                                                }


                                                $total_weight_kg_net= (($v*$net_weight_1)*$l_to_kg);
                                                $mt =  ($total_weight_kg/1000);
                                                $mt_rond = round($mt,2);    
                                                $mt1 = round($mt,4).' MT';


                                                $mt_net =  ($total_weight_kg_net/1000);
                                                $mt_rond_net = round($mt_net,2);    
                                            }
                                            else
                                            {
                                            ...
                                            if($value['packaging_type']!=1)
                                            {
                                                ...
                                                $sku_rate = round(($value['gross_weight']*$packing_rate_ltr),2);
                                            ...
                                            if($value['packaging_type']==3)
                                            {
                                               $net_weight = ($value['product_weight']/1000)*$value['packing_items_qty']; 
                                            }
                                            else
                                            {
                                                $net_weight = $value['product_weight']*$value['packing_items_qty']; 
                                            }

                                            $res .= '<input type="hidden" class="update_id_r" name="update_id[]" value="'.$update_id.'"><input type="hidden" class="packing_weight'.$i.' packing_weight" name="packing_weight[]" value="'.$mt.'">

                                                <input type="hidden" class="packing_weight_net'.$i.' packing_weight_net" name="packing_weight_net[]" value="'.$mt_net.'">

                                                <input type="hidden" class="packing_type" name="packing_type[]" value="'.$value['packaging_type'].'"><input type="hidden" class="packed_items_quantity" name="packed_items_quantity[]" value="'.$value['gross_weight'].'">
                                                <input type="hidden" class="packed_items_quantity_net" name="packed_items_quantity_net[]" value="'.$net_weight.'">
                                            ...
                                            $res .='<input type="text" class="form-control quantity_packed'.$i.' quantity_packed" id="" name="quantity[]"  value="'.$v.'" placeholder="'.$placeholder.'" '.$locked_readonly.' ></div></div><div class="col-md-3"><div class="form-group">';
                                             
                                            $res .='<input type="text" class="form-control  packing_weight_input packing_weight_input'.$i.'" id="" name=""  value="'.$mt.'" readonly>';
                                            ...
                                            $res .='</div></div><div class="col-md-1"><div class="form-group">';
                                             $res .='<span class="addmore btn btn-danger" rel="row_'.$i.'">+</span></div></div><div class="col-md-1"><div class="form-group lock_bt">';
                                             
                                      
                                            if($lock_img && $booking_info['status']==2)
                                             $res .='<span class="bt btn btn-danger '.$update_sku_status.'" data-status="'.$sku_status.'" rel="'.base64_encode($sku_id).'" data-id="'.$booking_info['id'].'"><img style="height: 17px;width: 17px;" src="'.base_url('assets/img').$lock_img.'"></span>'; 
                                            $res .='</div></div></div></div>';
                                            $i++;
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        $res .= '<input type="hidden" class="update_id_r" name="update_id[]" value="0"><input type="hidden" class="packing_weight'.$i.' packing_weight" name="packing_weight[]" value="'.$mt.'">
                                            <input type="hidden" class="packing_weight_net'.$i.' packing_weight_net" name="packing_weight_net[]" value="'.$mt_net.'">
                                            <input type="hidden" class="packing_type" name="packing_type[]" value="'.$value['packaging_type'].'"><input type="hidden" class="packed_items_quantity" name="packed_items_quantity[]" value="'.$value['gross_weight'].'">
                                        <input type="hidden" class="packed_items_quantity_net" name="packed_items_quantity_net[]" value="'.$net_weight.'">
                                        <input type="hidden" class="form-control  packing_rate" id="" name=""  value="'.$sku_rate.'" readonly placeholder="Rate">
                        ...
                        <div class="row">                               
                            <div class="col-md-4">
                                <div class="form-group"> 
                                    ...
                                    <br>
                                    <span class="txt-danger" style="padding-top: 10px; display: inline-block;">** Bargain is <?php echo  ($booking_info['is_lock']==1) ? 'locked.' :  'not locked yet.';   ?></span>
                                </div>                                  
                            </div>                                  
                        </div>  
                        <?php } else { ?> 
...
$(document).ready(function(){ 
    $(document).on('click', '.addmore', function(){  
        var selected_row = $(this).attr('rel');
        var selected_html = $("."+selected_row).html();  
        var numItems = $('.sku_row').length;
        numItems = numItems+1;
        var final_html = '<div class="sku_row row_'+numItems+'">'+selected_html+'</div>';         
        $("."+selected_row).after(final_html);
         
        $(".row_"+numItems+" .packing_weight" ).val(0);
        $(".row_"+numItems+" .quantity_packed" ).val(0); 
        $(".row_"+numItems+" .quantity_packed" ).removeAttr('readonly'); 
        $(".row_"+numItems+" .packing_weight_input" ).val(0);
        $(".row_"+numItems+" .bt" ).remove(); 
        $(".row_"+numItems+" .update_id_r" ).val(0); 

    });

    $(document).on('click', '.update_sku_status', function(){  
        var sku_id = $(this).attr('rel'); 
        var this_elicked = $(this);
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>booking/update_sku_status',
            data: { 'sku_id': sku_id,'booking_id': booking_id},
            success: function(msg){ 
                if(msg)
                { 
                    var loc = "<?php echo base_url('assets/img/lock.png'); ?>"; 
                    this_elicked.find('img').attr("src",loc);
                    $("#flag").val(2);
                    $(this).closest(".col-md-1").siblings('.col-md-4').find(".form-group").find(".quantity_packed").prop("readonly",true);
                    alert("SKU locked successfully");
                }
                else
                {
...
<?php 
$total_weight_ordered = $booking_info['total_weight'];
if(strtolower($booking_info['production_unit'])=='jaipur' && $booking_info['total_weight_net']>0)
    $total_weight_ordered = $booking_info['total_weight_net'];
 ?>
...
<script>
    ...
    $(document).ready(function() {
        var total_weight_ordered = '<?php echo $total_weight_ordered; ?>'; 
      ...
      $(window).keydown(function(event){
        ...
        $(document).on('blur', '.quantity_packed', function(){ 
            ...
            var packed_items_quantity_net = $(this).parent().find('.packed_items_quantity_net').val(); 

            var packing_rate = $(this).parent().find('.packing_rate').val(); 
            var packing_rate_total = parseFloat(packing_rate)*$(this).val();
            $(this).closest('.col-md-4').next('.col-md-3').find('.packing_rate_show').text(''+packing_rate+'*'+$(this).val()+' = '+packing_rate_total+' Rs.');

            var l_to_kg = 1;
            //var approx_weight=0.02;   
            var approx_weight=0.075;            
            if(packing_type!=1)
            {
                var l_to_kg = .91;
                //approx_weight = .0182; 
            ...
            var total_weight_kg_net= (((this.value)*packed_items_quantity_net)*l_to_kg);

            var mt =  (total_weight_kg/1000);
            var mt_rond = mt.toFixed(2);  

            var mt_net =  (total_weight_kg_net/1000);
            var mt_rond_net = mt_net.toFixed(2);  

            if(parseFloat(mt)>0)
            {
                var mt_t= mt.toFixed(4);
                var mt_t_net= mt_net.toFixed(4);
            ...
            $(this).siblings('.packing_weight_net').val(mt_net);
    ...
    <div class="modal-content">
        <form method="POST" id="">
            ...
            <div class="modal-footer"> 
                ...
                <a href="<?php echo base_url().'booking/report'; ?>" class="btn btn-default " >Close</a>
            </div>
        </form>
    </div>
