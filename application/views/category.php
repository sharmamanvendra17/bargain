                        ...
                        <?php if($categories) { 
                            ...
                            foreach ($categories as $key => $value) { ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $value['product_price']; echo ($value['is_ex_rate']) ? ' (Ex)' : ' (FOR)';  ?></td> 
                                    <td><a href="<?php echo base_url();?>category/edit_category/<?php echo base64_encode($value['id']) ?>">Edit</a> &nbsp; <a href="<?php echo base_url();?>category/delete_category/<?php echo base64_encode($value['id']) ?>" onClick="if(confirm('Are you want to sure delete this category?')) return true; else return false">Delete</a> &nbsp; <a href="<?php echo base_url();?>emptytinrate/add_rate/<?php echo base64_encode($value['brand_id']) ?>/<?php echo base64_encode($value['id']) ?>" >Add empty tin Rate</a> </</td> 
                                </tr>
                        <?php $i++; } } ?> 
                    </tbody>
                </table>
