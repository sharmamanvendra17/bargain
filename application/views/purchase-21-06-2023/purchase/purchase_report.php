                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php 
                                                ...
                                                <?php } elseif($value['status']==1) {  ?>
                                                    <span class="btn btn-default <?php echo ($logged_role == 1 || $logged_role == 4 || $logged_role == 5) ? 'update_status_reject' : 'style="cursor:none"'; ?>" data-status="3" rel="<?php echo base64_encode($value['id']); ?>" >Rejected</span>
                                                <?php } else {  ?>
                                                <span class="btn btn-danger <?php echo ($logged_role == 1 || $logged_role == 4 || $logged_role == 5) ? 'update_status_reject' : 'style="cursor:none"'; ?>"  data-status="3" rel="<?php echo base64_encode($value['id']); ?>" >Pending</span>
                                                <?php } ?> 
                                            </td> 
                                            <td>
