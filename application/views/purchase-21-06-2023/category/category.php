        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="title elipsis header_add">
                    <a href="<?php echo base_url();?>purchase/purchasecategory/add">Add New Category</a>
                </span>
            </div>
                        ...
                        <?php if($categories) { 
                            ...
                            foreach ($categories as $key => $value) { ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo base_url();?>purchase/purchasecategory/edit_category/<?php echo base64_encode($value['id']) ?>">Edit</a> </</td> 
                                </tr>
                        <?php $i++; } } ?> 
                    </tbody>
                </table>
