  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <form method="POST" id="">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default pi_invoice_download" data-dismiss="modal">Download PI</button> 
                <button type="button" class="btn btn-default pi_invoice" data-dismiss="modal">Send PI on my whatsapp</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
        </form>
    </div>
