                ...
                <div class="row">
                    <div class="col-md-12">                         
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control rate" id="rate" name="rate"  value="<?php if(isset($_POST['rate'])) echo $_POST['rate']; ?>" required>
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <div class="form-group"> 
                                        <input type="checkbox"  id="insurance" name="insurance" value="1"> Insurace Included in price 
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group"> 
                            ...
                            <?php $total_weight = 0; if($bookings) { 
                                ...
                                foreach ($bookings as $key => $value) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>DATA/<?php echo $value['booking_id']; ?></td>
                                        ...
                                        else 
                                        {
                                            if($value['is_lock'])
                                            { ?> 
                                                <span class="approve_btn btn btn-default" rel="<?php echo $value['id']; ?>">Approve</span>
                                            <?php } else  
                                            {
                                                echo " SKU Pending";
                                            }
                                        ...
                                        <td> 
                                            ...
                                            <?php } else { ?>
                                                <a href="javascript:void(0)" data-lock="<?php echo $value['is_close']; ?>" rel="<?php echo $value['booking_id']; ?>" class="btn btn-default detail btn_report1" data-production_unit="<?php echo $value['production_unit']; ?>" data-status="<?php echo $app_status; ?>">Report</a>
                                            <?php }  } ?>
                                        </td> 
                                    </tr>
                            <?php $count++; } } ?> 
        ...
        $(document).on("submit", "#addbooking", function(event){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo base_url(); ?>booking/BookingList', 
                        success: function(response){
                            $('.booking_records').html(response);
                        }
                    });
