                ...
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rate" id="rate" name="rate"  value="<?php echo $booking_info['rate']; ?>" required>
                        ...
                        $total_weight_input = $booking_info['total_weight_input'];
                         $disabled = 'disabled';  $approx_total_weight_ordered_min = $booking_info['total_weight']-$approx_weight;
                        $approx_total_weight_ordered_max = $booking_info['total_weight']+$approx_weight;
                        if($total_weight_input<$approx_total_weight_ordered_max && $total_weight_input>$approx_total_weight_ordered_min)
                        {
                            $disabled = '';
                        } 
                        ...
                        <div class="row">                               
                            <div class="col-md-4">
                                <div class="form-group"> 
                                    ...
                                    <input type="submit" class="btn btn-danger lock_order" value="Save & Lock Order" <?php echo $disabled; ?> name="lock"> 
                                </div>                                  
                            </div>                                  
                        </div>  
                        <?php } ?>                   
...
$(document).ready(function(){
    ...
    $(document).on("submit", "#addskus", function(event){
        ...
        if(activeElement=='Save & Lock Order'){
            $("#flag").val(1);
        }
    ...
    $(document).ready(function() {
      ...
      $(window).keydown(function(event){
        ...
        $(document).on('blur', '.quantity_packed', function(){ 
            ...
            {
                if(parseFloat(total_weight_input1)<parseFloat(approx_total_weight_ordered_max) && parseFloat(total_weight_input1)>parseFloat(approx_total_weight_ordered_min))
                {  
