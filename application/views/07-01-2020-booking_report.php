    	                        ...
    	                        <?php if($bookings) { 
    	                            ...
    	                            foreach ($bookings as $key => $value) { ?>
    	                                <tr class="odd gradeX">
                                            ...
                                            <a href="<?php echo base_url(); ?>booking/edit/<?php echo base64_encode($value['id']); ?>">Edit</a> &nbsp; <a href="<?php echo base_url(); ?>booking/delete/<?php echo base64_encode($value['id']); ?>"  onClick="if(confirm('Are you want to sure delete this order?')) return true; else return false">Delete</a> <?php } ?></td>
    	                                </tr>
    	                        <?php $i++; } } ?> 
    	                    </tbody>
    	                </table>
