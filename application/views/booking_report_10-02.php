                                ...
                                foreach ($bookings as $key => $value) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <?php } elseif($value['status']==2) { 
                                            $app_status = 1; ?>
                                            <span class="btn btn-default <?php echo ($logged_role == 4 || (($logged_in_id==$value['team_lead_id']) || $logged_role == 5)) ? 'update_status_reject' : 'style="cursor:none"'; ?>" data-status="3" rel="<?php echo base64_encode($value['id']); ?>" ><img style="height: 17px;width: 17px;" src="<?php echo base_url('assets/img').$lock_img; ?>"> 
