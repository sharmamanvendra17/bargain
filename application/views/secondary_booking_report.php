                                ...
                                foreach ($bookings as $key => $value) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <?php  } else { ?> 
                                            <a target="_blank" href="<?php echo base_url('invoices/secondary').'/'.str_replace('/','-',$value['invoice_file']);?>"  title="<?php echo $value['admin_name']; ?>">DATA/SEC/<?php echo $value['booking_id']; ?> 
                                                </a>
                                            <?php }  ?>
                                        </td>
                                        <td>
