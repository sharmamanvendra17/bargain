                            ...
                            <div class="row" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php if($logged_role==4 || $logged_role==9|| $logged_role==10|| $logged_role==11) { ?>
                                ...
                                <?php $total_weight = 0; if($bookings) { 
                                    ...
                                    foreach ($bookings as $key => $value) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <?php  $remaining_weight = ($value['pur_inventory_weight'])  ? ($value['weight']-$value['pur_inventory_weight']) : $value['weight']; ?> 
                                            <td><?php echo $value['weight'];  echo ($value['pur_inventory_weight']) ?  '<br><span style="color:green">'.round($value['pur_inventory_weight'],2).'</span>' : ''; 
                                                echo ($remaining_weight) ? '<br><span style="color:red">'.round($remaining_weight,2).'</span>' : '';
                                        ...
                                        ?> </td>  
                                            ...
                                            <td><?php 
                                                ...
                                                <?php } elseif($value['status']==4 ) {  ?>
                                                    <span class="btn btn-default <?php echo ($logged_role == 10 || $logged_role == 4 ) ? 'update_status_reject' : 'style="cursor:none"'; ?>" data-status="3" rel="<?php echo base64_encode($value['id']); ?>" >Approved</span>
                                                <?php } elseif($value['status']==0) {  ?>
                                                <span class="btn btn-danger <?php echo ($logged_role == 10 || $logged_role == 4 ) ? 'update_status_reject' : 'style="cursor:none"'; ?>"  data-status="3" rel="<?php echo base64_encode($value['id']); ?>" >Pending</span>
                                                <?php } ?> 
                                            </td> 
                                            <td>
