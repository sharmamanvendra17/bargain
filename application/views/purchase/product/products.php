        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="title elipsis header_add">
                    <a href="<?php echo base_url();?>purchase/purchaseproduct/add">Add New Product</a>
                </span>
            </div>
                        ...
                        <?php if($products) { 
                            ...
                            foreach ($products as $key => $value) { ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo base_url();?>purchase/purchaseproduct/edit_product/<?php echo base64_encode($value['id']) ?>">Edit</a> 
...
<script type="text/javascript"> 
    $(document).on('click', '.changeStatus', function () {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url();?>purchase/purchaseproduct/updateStatus',
