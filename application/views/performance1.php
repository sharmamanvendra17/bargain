                ...
                <div class="row">
                    <div class="col-md-12">                        
                        <div class="table-responsive">
                            ...
                            <?php $booking_summary =  GetTotalBookingsummary($postdata);  ?>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <table class="table accordionTable table-striped table-bordered table-hover ">
                                                            ...
                                                            <tr>
                                                                    <td>Total</td>
                                                                    <td><?php echo $total_bargain_weight_inline; ?></td>
                                                                    <td><?php echo $total_bargain_amount_inline; ?></td>
                                                                    <td><?php echo $total_pi_weight_inline; ?></td>
                                                                    <td><?php echo $total_pi_amount_inline; ?></td>
                                                                    <td><?php echo $total_pi_dispetch_weight_inline; ?></td>
                                                                    <td><?php echo $total_pi_dispetch_amount_inline; ?></td>
                                                                    <td colspan="2"></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                        ...
                                        <table class="table accordionTable table-striped table-bordered table-hover ">
                                            <thead>
                                              <tr>
                                                ...
                                                <th colspan="2" width="33%">Dispatched PI</th>
