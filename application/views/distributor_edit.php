                        ...
                        <div class="col-md-12">
                            <form action="" class="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $vendor_id_selected = $vendor['vendor_id']; 
                                        $vendor_ids = explode(',', $vendor_id_selected);
                                    ?>
                                    <select class="form-control" id="supplier" name="supplier[]" required="" multiple>
                                        <option value="">Select Supplier</option>
                                        <?php if($vendors) { 
                                            foreach ($vendors as $key => $value) { ?>
                                            <option value="<?php echo $value['id']; ?>" <?php  if(in_array($value['id'], $vendor_ids )) { echo "selected"; } ; ?>><?php echo $value['name'].' - '.$value['city_name']; ?></option>
                                        <?php } } ?>
                                    </select>
