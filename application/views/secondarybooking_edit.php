...
$(document).ready(function(){
    ...
    $(document).on('blur', '.quantity_packed', function(){  
        ...
        var category_name = $(this).parent().parent().prev().prev().prev().find('#category :selected').text().toLowerCase();
		//alert($(this).parent().parent().prev().prev().prev().find('#category :selected').text()); 
        ...
        if(!isNaN(available_qty) && available_qty<input_qty)
        {
            this.value = 0;
